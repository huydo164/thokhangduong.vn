                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control" name="statics_video" value="<?php if(isset($data['statics_video'])): ?><?php echo e($data['statics_video']); ?> <?php endif; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
...
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\project.vn\thokhangduong\app\Modules/Admin/Views/statics/add.blade.php ENDPATH**/ ?>