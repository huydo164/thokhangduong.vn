                ...
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                <div class="panel-body panel-search">
                                    <div class="form-group col-sm-2">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-sm" name="banner_title" <?php if(isset($search['banner_title']) && $search['banner_title'] !=''): ?>value="<?php echo e($search['banner_title']); ?>"<?php endif; ?>>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="<?php echo e(route('admin.banner')); ?>"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/banner/edit"><i class="ace-icon fa fa-plus-circle"></i>Thêm mới</a>
                        ...
                        <?php if(sizeof($data) > 0): ?>
                            ...
                            <?php endif; ?>
                            <br>
                            <form id="formListItem" method="POST" action="<?php echo e(FuncLib::getBaseUrl()); ?>admin/banner/delete" class="formListItem" name="txtForm">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <label class="pos-rel">
                                                    <input class="ace checkItem" name="checkItem[]" value="<?php echo e($item['banner_id']); ?>" type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td><?php echo e($item['banner_title']); ?></td>
                                            <td><?php echo e($item['banner_intro']); ?></td>

                                            <td><?php echo e(isset($arrType[$item['banner_type']]) ? $arrType[$item['banner_type']] : ''); ?></td>
                                            <td><?php echo e(isset($arrTarget[$item['banner_is_target']]) ? $arrTarget[$item['banner_is_target']] : ''); ?></td>
                                            <td><?php echo e(isset($arrRel[$item['banner_is_rel']]) ? $arrRel[$item['banner_is_rel']] : ''); ?></td>

                                            <td><?php echo e($item['banner_order_no']); ?></td>
                                            <td><?php echo e(date('d/m/Y', $item['banner_create_time'])); ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/banner/edit/<?php echo e($item['banner_id']); ?>" title="Cập nhật">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\project.vn\thokhangduong\app\Modules/Admin/Views/banner/list.blade.php ENDPATH**/ ?>