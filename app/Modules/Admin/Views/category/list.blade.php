                        ...
                        <div class="panel panel-info @if(isset($search['submit']) && $search['submit'] == CGlobal::status_show) act @endif">
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                ...
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="{{route('admin.category')}}"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                                    ...
                                    @foreach($data as $k=>$item)
                                        @if(!empty($item['parent']))
                                            <tr>
                                                ...
                                                <td><b>{{stripcslashes($item['parent']['category_title'])}}</b></td>
                                                <td>
                                                ...
                                                <td class="text-center">
                                                    @if($item['parent']['category_hot'] == '1')
                                                        <i class="fa fa-check fa-admin green"></i>
                                                    @else
                                                        <i class="fa fa-remove fa-admin red"></i>
                                                    @endif
                                                </td>
                                                <td class="text-center">{{$item['parent']['category_order_no']}}</td>
                                                <td class="text-center">
                                        ...
                                        @if(!empty($item['sub']))
                                            @foreach($item['sub'] as $key=>$sub)
                                                <tr>
                                                    ...
                                                    <td>---{{stripcslashes($sub['category_title'])}}</td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        @if($sub['category_hot'] == '1')
                                                            <i class="fa fa-check fa-admin green"></i>
                                                        @else
                                                            <i class="fa fa-remove fa-admin red"></i>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">{{$sub['category_order_no']}}</td>
                                                    <td class="text-center">
